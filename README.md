### **Описание:** 
- Набор UI-автотестов на pytest + Playwright с простыми скриншотными тестами
...
### **CI/Отчёты:**
- Allure-результаты сохраняются в `allure-results/`
- Генерировать отчёты через `allure serve`.
